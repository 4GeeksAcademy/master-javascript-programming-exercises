...
test('Function must returns the products of all the elements in the given array. Testing with [2,5,6].', () => {
  expect(computeProductOfAllElements([2, 5, 6])).toBe(60);
});
test('Function must returns the products of all the elements in the given array. Testing with [2,8,6].', () => {
  expect(computeProductOfAllElements([2, 8, 6])).toBe(96);
});
test('Function must returns the products of all the elements in the given array. Testing with [1,2,3].', () => {

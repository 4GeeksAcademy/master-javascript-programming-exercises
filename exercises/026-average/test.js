...
test ('The function should returns the correct average to the given params (24, 36).', () => {
    expect(average(24, 36)).toBe(30);
})
test ('The function should returns the correct average to the given params (102, 93).', () => {
